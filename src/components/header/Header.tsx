  ...
  return (
    <header className="w-full bg-[#4D96FF] text-white shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="text-2xl font-bold flex items-center gap-2" title="RandomWheel Home">
          <LuRefreshCw className="text-4xl" aria-hidden="true" />
          <span className="sr-only">RandomWheel Home</span>
        </Link>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-5" aria-label="Main navigation">
          <Link href="/" className="text-xl font-semibold p-3 rounded-xl hover:bg-[rgba(255,255,255,0.25)] transition-colors duration-300" title="Spin the Wheel">
            Spin Wheel
          </Link>
          <Link href="/coinflip" className="text-xl font-semibold p-3 rounded-xl hover:bg-[rgba(255,255,255,0.25)] transition-colors duration-300" title="Flip a Coin">
            Coin Flip
          </Link>
          <Link href="/cardspin" className="text-xl font-semibold p-3 rounded-xl hover:bg-[rgba(255,255,255,0.25)] transition-colors duration-300" title="Card Spinner">
            Card Spin
          </Link>
        </nav>
